...
class LossComb:
    ...
    BIRDNET = {'bbox2d': 1., 'object': 10, 'bbox3d': .1, 'yaw_reg': 1., 'yaw_cls': .0001, "category": .1}
...
class TrainingPlan:
    ...
    A2D2_SIMPLE = [
        ('a2d2', 50, 0.001, LossComb.BIRDNET, True),
        ('a2d2', 30, 0.0001, LossComb.BIRDNET, True),
        ('a2d2', 20, 0.000001, LossComb.BIRDNET, True),
        ('a2d2', 10, 0.0000001, LossComb.BIRDNET, True),
    ]
