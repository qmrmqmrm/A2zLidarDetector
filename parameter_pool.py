...
class LossComb:
    ...
    BIRDNET = {'bbox2d': .001, 'object': 10., 'bbox3d': .1, 'yaw_reg': 1., 'yaw_cls': .1, "category": 1.}
    BIRDNET_ = {'bbox2d': .001, 'object': 10.}
...
class TrainingPlan:
    ...
    A2D2_SIMPLE = [
        ('a2d2', 20, 0.001, LossComb.BIRDNET, True),
        # ('a2d2', 5, 0.000001, LossComb.BIRDNET, True),
        # ('a2d2', 5, 0.0000001, LossComb.BIRDNET, True),
        # ('a2d2', 5, 0.00000001, LossComb.BIRDNET, True),
        # ('a2d2', 5, 0.000000001, LossComb.BIRDNET, True),
        # ('a2d2', 5, 0.000000001, LossComb.BIRDNET, True),
    ]
